...
const SingleMenuItem = () => {
    const {setTabMenuStatus} = useContext(GeneralContext)
   
    return (
        <div onClick={()=>setTabMenuStatus ((prev)=> ({...prev,isMenuEdit:true}))} className='p-2 flex flex-col justify-center items-center shadow-lg hover:shadow-2xl cursor-pointer'>
